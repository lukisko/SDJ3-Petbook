#pragma checksum "C:\Users\nicol\RiderProjects\SDJ3-Petbook\ClientApp\Shared\NavMenu.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "416ff070d6e9aeab0516ac2b4a2cbe0dfe11e6dd"
// <auto-generated/>
...
#nullable disable
            ...
            __builder.AddAttribute(78, "class", " px-4 py-2 text-sm text-gray-700 hover:bg-gray-100  ");
...
#nullable disable
            ...
            __builder.AddMarkupContent(84, @"<div class=""flex flex-row"" b-3dzslfjxd2><label b-3dzslfjxd2>Switch Profile</label>
                                        <div class=""rounded-full border border-grey w-5 h-5 flex items-center justify-center test mt-0.5 ml-14"" b-3dzslfjxd2><svg class=""h-5 w-5 text-gray-800"" xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 20 20"" fill=""currentColor"" b-3dzslfjxd2><path fill-rule=""evenodd"" d=""M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"" clip-rule=""evenodd"" b-3dzslfjxd2></path></svg></div></div>");
#nullable restore
#line 108 "C:\Users\nicol\RiderProjects\SDJ3-Petbook\ClientApp\Shared\NavMenu.razor"
                                     if (AccountsWindow)
                                    {
...
#nullable disable
            ...
            __builder.AddAttribute(87, "role", "menu");
            __builder.AddAttribute(88, "aria-orientation", "vertical");
            __builder.AddAttribute(89, "aria-labelledby", "user-menu-button");
            __builder.AddAttribute(90, "tabindex", "-1");
            __builder.AddAttribute(91, "b-3dzslfjxd2");
            __builder.OpenElement(92, "ul");
            __builder.AddAttribute(93, "class", " absolute  text-gray-700 pl-5 ml-24 -mt-10  ");
            __builder.AddAttribute(94, "b-3dzslfjxd2");
#nullable restore
#line 112 "C:\Users\nicol\RiderProjects\SDJ3-Petbook\ClientApp\Shared\NavMenu.razor"
...
#nullable disable
            ...
            __builder.AddAttribute(96, "class", "block bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap");
            __builder.AddAttribute(97, "b-3dzslfjxd2");
            __builder.OpenElement(98, "div");
            __builder.AddAttribute(99, "class", "flex flex-row");
...
#nullable disable
            ...
            __builder.AddAttribute(108, "class", " px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex flex-row ");
            __builder.AddAttribute(109, "role", "menuitem");
            __builder.AddAttribute(110, "tabindex", "-1");
            __builder.AddAttribute(111, "id", "user-menu-item-1");
...
#nullable disable
            ...
            __builder.AddAttribute(115, "class", "block bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap ");
            __builder.AddAttribute(116, "b-3dzslfjxd2");
            __builder.OpenElement(117, "a");
            __builder.AddAttribute(118, "class", " px-4  text-sm text-gray-700 hover:bg-gray-100  ");
            __builder.AddAttribute(119, "role", "menuitem");
            __builder.AddAttribute(120, "tabindex", "-1");
            __builder.AddAttribute(121, "id", "user-menu-item-1");
...
#nullable disable
            ...
            __builder.AddMarkupContent(124, @"<div class=""flex flex-row"" b-3dzslfjxd2><label b-3dzslfjxd2>Add Profile</label>
                                                            <div class=""rounded-full border border-grey  flex items-center justify-center test  ml-14"" b-3dzslfjxd2><svg xmlns=""http://www.w3.org/2000/svg"" class=""h-6 w-6"" fill=""none"" viewBox=""0 0 24 24"" stroke=""currentColor"" b-3dzslfjxd2><path stroke-linecap=""round"" stroke-linejoin=""round"" stroke-width=""2"" d=""M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"" b-3dzslfjxd2></path></svg></div></div>");
            __builder.CloseElement();
            __builder.CloseElement();
            __builder.CloseElement();
            __builder.CloseElement();
...
#nullable disable
            ...
            __builder.AddAttribute(129, "class", "block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100");
            __builder.AddAttribute(130, "role", "menuitem");
            __builder.AddAttribute(131, "tabindex", "-1");
            __builder.AddAttribute(132, "id", "user-menu-item-2");
...
#nullable disable
            ...
            __builder.AddAttribute(134, "b-3dzslfjxd2");
            ...
            __builder.AddAttribute(140, "class", "block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100");
            __builder.AddAttribute(141, "role", "menuitem");
            __builder.AddAttribute(142, "tabindex", "-1");
            __builder.AddAttribute(143, "id", "user-menu-item-2");
...
#nullable disable
            ...
            __builder.AddAttribute(149, "class", "sm:hidden");
            __builder.AddAttribute(150, "id", "mobile-menu");
            __builder.AddAttribute(151, "b-3dzslfjxd2");
            __builder.OpenElement(152, "div");
            __builder.AddAttribute(153, "class", "px-2 pt-2 pb-3 space-y-1");
            __builder.AddAttribute(154, "b-3dzslfjxd2");
#nullable restore
#line 170 "C:\Users\nicol\RiderProjects\SDJ3-Petbook\ClientApp\Shared\NavMenu.razor"
         if (BurgerMenu)
        {
...
#line hidden
#nullable disable
            __builder.AddMarkupContent(155, @"<div class="" flex items-center  justify-start my-2"" b-3dzslfjxd2><div class=""  flex items-center border-2 rounded-xl "" b-3dzslfjxd2><button class="" px-3 border-r"" b-3dzslfjxd2><svg class=""w-auto h-4 text-white"" fill=""currentColor"" xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 24 24"" b-3dzslfjxd2><path d=""M16.32 14.9l5.39 5.4a1 1 0 0 1-1.42 1.4l-5.38-5.38a8 8 0 1 1 1.41-1.41zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"" b-3dzslfjxd2></path></svg></button>
            ...
            __builder.AddAttribute(157, "class", "flex flex-row space-x-1 hover:text-gray-300  text-white block px-3 py-2 rounded-md text-base font-medium");
            __builder.AddAttribute(158, "b-3dzslfjxd2");
            __builder.OpenElement(159, "svg");
            __builder.AddAttribute(160, "xmlns", "http://www.w3.org/2000/svg");
            __builder.AddAttribute(161, "class", "h-5 w-auto mt-0.5");
            __builder.AddAttribute(162, "fill", "none");
            __builder.AddAttribute(163, "viewBox", "0 0 24 24");
            __builder.AddAttribute(164, "stroke", "currentColor");
            __builder.AddAttribute(165, "b-3dzslfjxd2");
            __builder.OpenElement(166, "path");
            __builder.AddAttribute(167, "stroke-linecap", "round");
            __builder.AddAttribute(168, "stroke-linejoin", "round");
            __builder.AddAttribute(169, "stroke-width", "2");
            __builder.AddAttribute(170, "d", "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z");
...
#nullable disable
            ...
            __builder.AddMarkupContent(174, "<a class=\" space-x-6\" aria-current=\"page\" b-3dzslfjxd2>Browse Pets</a>");
            __builder.CloseElement();
            __builder.OpenElement(175, "div");
            __builder.AddAttribute(176, "class", "flex flex-row space-x-1 hover:text-gray-300  text-white block px-3 py-2 rounded-md text-base font-medium");
            __builder.AddAttribute(177, "b-3dzslfjxd2");
            __builder.OpenElement(178, "svg");
            __builder.AddAttribute(179, "xmlns", "http://www.w3.org/2000/svg");
            __builder.AddAttribute(180, "class", "h-5 w-auto mt-0.5");
            __builder.AddAttribute(181, "fill", "none");
            __builder.AddAttribute(182, "viewBox", "0 0 24 24");
            __builder.AddAttribute(183, "stroke", "currentColor");
            __builder.AddAttribute(184, "b-3dzslfjxd2");
            __builder.OpenElement(185, "path");
            __builder.AddAttribute(186, "stroke-linecap", "round");
            __builder.AddAttribute(187, "stroke-linejoin", "round");
            __builder.AddAttribute(188, "stroke-width", "2");
            __builder.AddAttribute(189, "d", "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6");
...
#nullable disable
            ...
            __builder.AddMarkupContent(193, "<a class=\" space-x-6\" aria-current=\"page\" b-3dzslfjxd2>Home</a>");
            __builder.CloseElement();
            __builder.AddMarkupContent(194, @"<div class=""flex flex-row space-x-1 hover:text-gray-300  text-white block px-3 py-2 rounded-md text-base font-medium"" b-3dzslfjxd2><svg xmlns=""http://www.w3.org/2000/svg"" class=""h-5 w-auto mt-0.5"" fill=""none"" viewBox=""0 0 24 24"" stroke=""currentColor"" b-3dzslfjxd2><path stroke-linecap=""round"" stroke-linejoin=""round"" stroke-width=""2"" d=""M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"" b-3dzslfjxd2></path></svg>
                <a class="" space-x-6"" aria-current=""page"" b-3dzslfjxd2>Messages</a></div>");
            __builder.OpenElement(195, "div");
            __builder.AddAttribute(196, "class", "flex flex-row space-x-1 hover:text-gray-300  text-white block px-3 py-2 rounded-md text-base font-medium");
            __builder.AddAttribute(197, "b-3dzslfjxd2");
            __builder.OpenElement(198, "svg");
            __builder.AddAttribute(199, "class", "h-5 w-auto mt-0.5");
            __builder.AddAttribute(200, "xmlns", "http://www.w3.org/2000/svg");
            __builder.AddAttribute(201, "fill", "none");
            __builder.AddAttribute(202, "viewBox", "0 0 24 24");
            __builder.AddAttribute(203, "stroke", "currentColor");
            __builder.AddAttribute(204, "aria-hidden", "true");
            __builder.AddAttribute(205, "b-3dzslfjxd2");
            __builder.OpenElement(206, "path");
            __builder.AddAttribute(207, "stroke-linecap", "round");
            __builder.AddAttribute(208, "stroke-linejoin", "round");
            __builder.AddAttribute(209, "stroke-width", "2");
            __builder.AddAttribute(210, "d", "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9");
...
#nullable disable
            ...
            __builder.AddAttribute(212, "b-3dzslfjxd2");
            __builder.CloseElement();
            __builder.CloseElement();
            __builder.AddMarkupContent(213, "\r\n                ");
            __builder.AddMarkupContent(214, "<a class=\" space-x-6\" aria-current=\"page\" b-3dzslfjxd2>Notifications</a>");
            __builder.CloseElement();
#nullable restore
#line 213 "C:\Users\nicol\RiderProjects\SDJ3-Petbook\ClientApp\Shared\NavMenu.razor"
        }
